...
public class ActiveRecordJavacHandler extends JavacAnnotationHandler<ActiveRecordLombok> {

    @Override
    public void handle(AnnotationValues<ActiveRecordLombok> annotation, JCTree.JCAnnotation ast, JavacNode annotationNode) {
        ...
        //remove annotation
        deleteAnnotationIfNeccessary(annotationNode, ActiveRecordLombok.class);
        //remove import
